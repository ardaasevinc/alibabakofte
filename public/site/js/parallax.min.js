function mr_parallax() {
    ...
    function t() {
        ((B = void 0 == window.mr_variant ? !1 : !0),
            ...
            void 0 != b &&
                ...
                // Modern tarayıcılar için kritik düzeltme: passive: false
    ...
    // Intervention hatasını durduran kritik fonksiyon
    function s(e) {
        // Eğer olay iptal edilebilirse ve preventDefault varsa çalıştır
...
// Modern Wheel Listener (Passive: False Destekli)
(function (e, t) {
    var a,
        l = "";
    ...
    e.addWheelListener = function (target, callback, options) {
        // Options nesnesini kontrol et ve passive: false zorla
        var safeOptions =
            typeof options === "object"
                ? options
                : { capture: options || false };
        safeOptions.passive = false;

        _n(target, a, callback, safeOptions);
        if ("DOMMouseScroll" == a)
            _n(target, "MozMousePixelScroll", callback, safeOptions);
    };
