...
function mr_parallax() {
    ...
    function t() {
        ((B = void 0 == window.mr_variant ? !1 : !0),
            ...
            void 0 != b &&
                (b.addEventListener("scroll", i, !1),
                window.addWheelListener(b, s, !1),
    ...
    function l(e, t) {
        if (B) {
            ...
            if (e.isFirstSection) {
                ...
                var n = "translate3d(0, " + (t + f - e.elemTop) / 2 + "px, 0)";
                e.imageHolder.style[c] = n;
            }
    }
    function r() {
    ...
    ($(document).ready(function () {
        ...
        ((f = Math.max(
            ...
            /Android|iPad|iPhone|iPod|BlackBerry|Windows Phone/i.test(
                ...
                : m && (window.mr_parallax.profileParallaxElements(), t()));
    }),
            ...
            ((d = []),
                ...
                $(selector).each(function () {
                    ...
                    (d.push({
                        ...
                        isFirstSection: e.is(":first-of-type") ? !0 : !1,
                        imageHolder: $(this).get(0),
                    }),
                        B
                            ? B &&
                              (e.is(":first-of-type")
                                  ? k.mr_setTranslate3DTransform(
                                        $(this).get(0),
                                        0 == r() ? 0 : r() / 2,
                                    )
                                  : k.mr_setTranslate3DTransform(
            ...
            (a =
                "onwheel" in t.createElement("div")
                    ...
                    : void 0 !== t.onmousewheel
                      ? "mousewheel"
                      : "DOMMouseScroll"),
            (e.addWheelListener = function (e, t, o) {
                (n(e, a, t, o),
                    "DOMMouseScroll" == a && n(e, "MozMousePixelScroll", t, o));
            }));
    })(window, document));
